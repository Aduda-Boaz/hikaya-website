    ...
    return (
      <Html>
        <Head crossOrigin="" nonce="">
          ...
          <meta
            name="description"
            content="We help nonprofits tell their story through data by introducing open source, flexible, and integrated tools that improve the use of data."
          />
          <meta
            property="og:title"
            content="Tell your story through data and technology | Hikaya"
          />
          <meta
